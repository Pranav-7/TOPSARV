...
(function() {
  ...
  let scrollwp = document.querySelector('.scroll-wp');

  function toggleScrollwp() {
    if (scrollwp) {
      window.scrollY > 100 ? scrollwp.classList.add('active') : scrollwp.classList.remove('active');
    }
  }
  scrollwp.addEventListener('click', (e) => {
    window.scrollTo({
      top: 0,
      behavior: 'smooth'
    });
  ...
  window.addEventListener('load', toggleScrollwp);
  document.addEventListener('scroll', toggleScrollwp);
